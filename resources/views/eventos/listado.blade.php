...
@section('content')
    ...
    <div class="modal fade" id="modal_agregar" role="dialog">
        <form class="form-horizontal" method="POST" action="{{ route('registro_evento') }}">
            {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <form class="form-horizontal" method="POST" action="{{ route('editar_evento') }}">
            {{ csrf_field() }}
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <script src="{{ asset('js/eventos/script.js') }}"></script>
@endsection
